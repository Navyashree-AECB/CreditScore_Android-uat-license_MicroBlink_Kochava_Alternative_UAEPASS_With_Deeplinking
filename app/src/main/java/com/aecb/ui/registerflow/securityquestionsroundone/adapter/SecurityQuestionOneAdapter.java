package com.aecb.ui.registerflow.securityquestionsroundone.adapter;
...
public class SecurityQuestionOneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<QuestionsItem> questionsList = new ArrayList<>();
    private Context context;

    public SecurityQuestionOneAdapter(Context context, List<QuestionsItem> questionsList) {
