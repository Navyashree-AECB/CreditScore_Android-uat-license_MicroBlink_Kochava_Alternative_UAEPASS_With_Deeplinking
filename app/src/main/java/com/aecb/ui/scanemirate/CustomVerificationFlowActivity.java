package com.aecb.ui.scanemirate;
...
import com.aecb.R;
import com.aecb.microblink.managers.DocumentViewfinderManager;
   ...
   /* private void onScanDoneWithSuccess() {
    ...
    private View createCombinedStepCameraOverlay() {
        ...
        mDocumentViewfinderManager = new DocumentViewfinderManager(
                documentOverlay.findViewById(R.id.viewfinderRectangle),
                documentOverlay.findViewById(R.id.tvCardMessage),
                documentOverlay.findViewById(R.id.ivCardIcon)
        );
