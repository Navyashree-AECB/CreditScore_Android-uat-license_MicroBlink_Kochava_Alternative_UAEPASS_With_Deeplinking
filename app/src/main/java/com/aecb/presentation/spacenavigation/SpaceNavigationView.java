 ...
 * You may obtain bottom_line copy of the License at
 *
...
public class SpaceNavigationView extends RelativeLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //setBackground(ContextCompat.getDrawable(context,R.drawable.xxx));
    ...
    private void updateSpaceItems(final int selectedIndex) {
        ...
        /**
         * Set bottom_line listener that gets fired when the selected item changes
         *
         * @param listener bottom_line listener for monitoring changes in item selection
         */
        if (spaceOnClickListener != null && selectedIndex >= 0)
    ...
    /**
     * Indicate event queue that we have changed the View hierarchy during bottom_line layout pass
     */
